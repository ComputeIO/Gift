...
impl ClientHandler for LeafClient {
    async fn list_roots(
        &self,
...
pub struct McpClient {
    client: Mutex<RunningService<RoleClient, LeafClient>>,
...
impl McpClient {
        ...
        E: std::error::Error + From<std::io::Error> + Send + Sync + 'static,
    {
        ...
        let client: rmcp::service::RunningService<rmcp::RoleClient, LeafClient> =
