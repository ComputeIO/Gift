...
You review code."#;
    ...
    async fn test_source_discovery_and_priority() {
        ...
        let recipes = temp_dir.path().join(".leaf/recipes");
    ...
    async fn test_skill_supporting_files_discovered() {
        ...
        let skill_dir = temp_dir.path().join(".leaf/skills/my-skill");
    ...
    async fn test_skill_name_with_slash_is_rejected() {
        ...
        let skill_dir = temp_dir.path().join(".leaf/skills/bad-skill");
        fs::create_dir_all(&skill_dir).unwrap();
        fs::write(
            skill_dir.join("SKILL.md"),
