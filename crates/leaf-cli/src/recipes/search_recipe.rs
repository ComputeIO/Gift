...
use super::github_recipe::{
    ...
    LEAF_RECIPE_GITHUB_REPO_CONFIG_KEY,
};
use leaf::recipe::local_recipes::{list_local_recipes, load_local_recipe_file};
...
fn configured_github_recipe_repo() -> Option<String> {
    ...
    match config.get_param(LEAF_RECIPE_GITHUB_REPO_CONFIG_KEY) {
