...
use leaf::execution::manager::AgentManager;
...
use leaf::agents::ExtensionLoadResult;
use leaf::gateway::manager::GatewayManager;
...
impl AppState {
    ...
    pub async fn get_agent(&self, session_id: String) -> anyhow::Result<Arc<leaf::agents::Agent>> {
    ...
    pub async fn get_agent_for_route(
        &self,
        session_id: String,
    ) -> Result<Arc<leaf::agents::Agent>, StatusCode> {
