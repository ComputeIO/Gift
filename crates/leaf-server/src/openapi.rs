...
use leaf::agents::extension::ToolInfo;
...
use leaf::permission::permission_confirmation::{Permission, PrincipalType};
use leaf::providers::base::{ConfigKey, ModelInfo, ProviderMetadata, ProviderType};
use leaf::session::{Session, SessionInsights, SessionType, SystemInfo};
use rmcp::model::{
...
#[openapi(
    ...
    components(schemas(
        ...
        leaf::providers::catalog::ProviderCatalogEntry,
        leaf::providers::catalog::ProviderTemplate,
        leaf::providers::catalog::ModelTemplate,
        leaf::providers::catalog::ModelCapabilities,
        ...
        ModelConfig,
        Session,
        leaf::config::leaf_mode::LeafMode,
        SessionInsights,
        SessionType,
        SystemInfo,
        Conversation,
        IconSchema,
        leaf::session::extension_data::ExtensionData,
        ...
        leaf::recipe::Recipe,
        leaf::recipe::Author,
        leaf::recipe::Settings,
        leaf::recipe::RecipeParameter,
        leaf::recipe::RecipeParameterInputType,
        leaf::recipe::RecipeParameterRequirement,
        leaf::recipe::Response,
        leaf::recipe::SubRecipe,
        leaf::agents::types::RetryConfig,
        leaf::agents::types::SuccessCheck,
        ...
        leaf::agents::ExtensionLoadResult,
