# 🍳 Contributing Recipes to leaf Cookbook

Thank you for your interest in contributing to the leaf Recipe Cookbook! This guide will walk you through the process of submitting your own recipe.

## 🚀 Quick Start

1. [Fork this repository](https://github_com_block_leaf_placeholder/fork)
...
📚 **Need help with the format?** Check out the [Recipe Reference Guide](https://block.github.io/leaf/docs/guides/recipes/recipe-reference) or [existing recipes](documentation/src/pages/recipes/data/recipes/) for examples.
...
- [ ] **Follow the format** - Refer to the [Recipe Reference Guide](https://block.github.io/leaf/docs/guides/recipes/recipe-reference)
...
- 📚 **Check the docs** at [block.github.io/leaf](https://block.github.io/leaf/docs/guides/recipes/)
...
**Ready to contribute?** [Fork the repo](https://github_com_block_leaf_placeholder/fork) and start creating! 

*Questions? Ask in your PR or hop into [discord](https://discord.gg/leaf-oss) - we're here to help!* 💙
